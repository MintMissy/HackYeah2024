...
export class SpeechService {
  private readonly _speechRecognition = (<any>window).SpeechRecognition || (<any>window).webkitSpeechRecognition;
  ...
  speechToText(): Observable<string> {
    ...
    return new Observable((subscriber) => {
      ...
      recognition.onend = () => {
        const isStillSpeaking = Date.now() - lastSpoken < this.DEACTIVATE_SILENCE_DURATION
